...
import { FaUser, FaEnvelope, FaIdCard, FaCalendar, FaMapMarkerAlt, FaPhone, FaTint, FaClock, FaSave, FaTimes, FaChevronLeft, FaChevronRight, FaUserPlus, FaDownload } from 'react-icons/fa'
  ...
  const handleAddUserSubmit = async (e) => {
    ...
    try {
      ...
      const updatedUser = {
        ...
        "Blood-group": userData.blood_group || userData.bloodGroup || userData["Blood-group"] || userWithId["Blood-group"] || ""
      };
            ...
            <div className="animate-fade-in-up relative rounded-lg bg-white p-6 shadow dark:bg-gray-800">
              ...
              <form onSubmit={handleAddUserSubmit} className="space-y-6">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label htmlFor="new-firstName" className="form-label">First Name</label>
                    <input
                      type="text"
                      id="new-firstName"
                      name="name.first"
                  ...
                  <div>
                    <label htmlFor="new-lastName" className="form-label">Last Name</label>
                    <input
                      type="text"
                      id="new-lastName"
                      name="name.last"
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    <label htmlFor="new-blood-group" className="form-label">Blood Group</label>
                    <input
                      type="text"
                      id="new-blood-group"
                      name="Blood-group"
                ...
                <div>
                  <label htmlFor="new-phone" className="form-label">Phone</label>
                  <input
                    type="text"
                    id="new-phone"
                    name="phone"
                ...
                <div>
                  <label htmlFor="new-dob" className="form-label">Date of Birth</label>
                  <input
                    type="date"
                    id="new-dob"
                    name="dateOfBirth"
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="form-label" htmlFor="new-street">Street</label>
                    <input
                      type="text"
                      id="new-street"
                      name="address.street"
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      <label className="form-label" htmlFor="new-postalCode">Postal Code</label>
                      <input
                        type="text"
                        id="new-postalCode"
        ...
        <div className="card col-span-1 flex flex-col items-center p-6 text-center">
          ...
          <div className="mt-4 flex w-full flex-col space-y-2 px-2">
            ...
            <div className="flex items-center space-x-2 rounded-md px-2 py-1 hover:bg-gray-100 dark:hover:bg-gray-800">
              ...
              <span className="text-sm text-gray-600 dark:text-gray-300">Blood: {formData["Blood-group"] || "Not Specified"}</span>
            </div>
            <div className="flex items-center space-x-2 rounded-md px-2 py-1 hover:bg-gray-100 dark:hover:bg-gray-800">
              <FaMapMarkerAlt className="h-4 w-4 text-gray-500 dark:text-gray-400" />
              <span className="text-sm text-gray-600 dark:text-gray-300">{formData.address.city}, {formData.address.country}</span>
            </div>
            <div className="flex items-center space-x-2 rounded-md px-2 py-1 hover:bg-gray-100 dark:hover:bg-gray-800">
          ...
          <div className="border-b border-gray-200 dark:border-gray-700">
            <ul className="flex flex-wrap -mb-px text-sm font-medium text-center" role="tablist">
              <li className="mr-2" role="presentation">
                <button 
                  className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'personal' ? 
              ...
              <li className="mr-2" role="presentation">
                <button 
                  className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'address' ? 
                    'text-primary-600 border-primary-600 dark:text-primary-400 dark:border-primary-400' : 
                    'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}`}
              ...
              <li role="presentation">
                <button 
                  className={`inline-block p-4 border-b-2 rounded-t-lg ${activeTab === 'account' ? 
                    'text-primary-600 border-primary-600 dark:text-primary-400 dark:border-primary-400' : 
                    'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300'}`}
            ...
            {activeTab === 'account' && (
              <div className="space-y-6 animate-fade-in">
                <form onSubmit={handleSubmit}>
                  <div className="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                      <label className="form-label" htmlFor="accountCreated">Account Created</label>
                      <input
                        type="text"
                        id="accountCreated"
                        name="accountCreated"
